...
final class QuickChallengeInteractor: BaseQuestionInteractor {
    init() {
        super.init(questions: [
            .quickChallenge: [
                Question(title: "Do 10 jumping jacks.", options: nil, type: .quickChallenge),
                Question(title: "Hold your breath for 30 seconds.", options: nil, type: .quickChallenge),
                Question(title: "Spin around 10 times and try to walk in a straight line.", options: nil, type: .quickChallenge),
                Question(title: "Balance a spoon/pen on your nose for 10 seconds.", options: nil, type: .quickChallenge),
                Question(title: "Recite the alphabet backwards as fast as you can.", options: nil, type: .quickChallenge),
                Question(title: "Do your best animal impression.", options: nil, type: .quickChallenge),
